...
CREATE TABLE Game (
  ...
  FOREIGN KEY (comp_id, home_club_id) REFERENCES ClubPlaysIn(comp_id, club_id),
  FOREIGN KEY (comp_id, away_club_id) REFERENCES ClubPlaysIn(comp_id, club_id),
...
CREATE TABLE PlayerSeason (
  ...
  FOREIGN KEY (comp_id, club_id) REFERENCES ClubPlaysIn(comp_id, club_id)
